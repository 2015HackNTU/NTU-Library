...
module.exports = {
  enable: function(instance) {
    //instance is svg-pan-zoom's window.screen.width and window.screen.height 
    ...
    // Demostration Group
    var demostrationGroup = document.createElementNS(SvgUtils.svgNS, 'g');
    demostrationGroup.setAttribute('id', 'svg-pan-zoom-demostration');
    demostrationGroup.setAttribute('transform', 'translate(' + ( instance.width - 600 ) + ' ' + ( instance.height - 130 ) + ') scale(1)');
    demostrationGroup.setAttribute('class', 'svg-pan-zoom-demostration');
    ...
    demostrationGroup.appendChild(this._createDemostration(instance))

    // Finally append created element
    instance.svg.appendChild(zoomGroup)
    instance.svg.appendChild(demostrationGroup)

    // Cache control instance
    instance.controlIcons = zoomGroup
    instance.controlIcons = demostrationGroup
  }
...
, _createDemostration: function(instance){
    
    var demostration = document.createElementNS(SvgUtils.svgNS, 'g');
    demostration.setAttribute('id', 'svg-pan-zoom-Demostrations');
    demostration.setAttribute('transform', 'translate(280.5 -200) scale(1)');
    demostration.setAttribute('class', 'svg-pan-zoom-Demostrations');

    var demostrationBackground = document.createElementNS(SvgUtils.svgNS, 'path');
    demostrationBackground.setAttribute('d', 'M-314,278.3h201c1.7,0,3,1.3,3,3v33c0,1.7-1.3,3-3,3h-201'
      +'c-1.7,0-3-1.3-3-3v-33C-317,279.6-315.7,278.3-314,278.3z');
    demostrationBackground.setAttribute('class', 'svg-pan-zoom-Demostrations-element');
    demostrationBackground.setAttribute('style', 'fill:#E4E4E4');
    demostration.appendChild(demostrationBackground);

    var demostrationElement = document.createElementNS(SvgUtils.svgNS, 'ellipse');
    demostrationElement.setAttribute('cx', '-298.4');
    demostrationElement.setAttribute('cy', '296.2');
    demostrationElement.setAttribute('rx', '7.9');
    demostrationElement.setAttribute('ry', '7.9');
    demostrationElement.setAttribute('class', 'svg-pan-zoom-Demostrations-element');
    demostrationElement.setAttribute('style', 'fill:#6DBD76');
    demostration.appendChild(demostrationElement);

    var demostrationElement = document.createElementNS(SvgUtils.svgNS, 'ellipse');
    demostrationElement.setAttribute('cx', '-232.1');
    demostrationElement.setAttribute('cy', '295.9');
    demostrationElement.setAttribute('rx', '7.9');
    demostrationElement.setAttribute('ry', '7.9');
    demostrationElement.setAttribute('class', 'svg-pan-zoom-Demostrations-element');
    demostrationElement.setAttribute('style', 'fill:#EDAF5A');
    demostration.appendChild(demostrationElement);

    var demostrationElement = document.createElementNS(SvgUtils.svgNS, 'ellipse');
    demostrationElement.setAttribute('cx', '-165.9');
    demostrationElement.setAttribute('cy', '295.3');
    demostrationElement.setAttribute('rx', '7.9');
    demostrationElement.setAttribute('ry', '7.9');
    demostrationElement.setAttribute('class', 'svg-pan-zoom-Demostrations-element');
    demostrationElement.setAttribute('style', 'fill:#D65454');
    demostration.appendChild(demostrationElement);
    ...
    demostrationText.setAttribute('transform', 'matrix(1 0 0 1 -316.5518 297.4376)');
    demostrationElement.setAttribute('style', 'fill:#AFB1B2;font-family:STHeitiTC-Medium;font-size:18px');
